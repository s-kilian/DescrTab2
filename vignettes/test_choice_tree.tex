...
Test choices can be manually overwritten. E.g. if you want to calculate Boschloo's test only for the gender variable and use a chi-squared test (default) for everything else, you can request this by supplying the following argument: \\
